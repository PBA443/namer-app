...
// ---------------------------------------------------
// "Continue" button එක click කළාම, data save කරලා, Success Page එකට යන විදියට හදලා තියෙන්නේ.
// ---------------------------------------------------
...
class UserPersonalInfoPage extends StatefulWidget {
  final User user;
  const UserPersonalInfoPage({super.key, required this.user});
...
class _UserPersonalInfoPageState extends State<UserPersonalInfoPage> {
  ...
  // --- "Continue" button එකේ නිවැරදි logic එක ---
